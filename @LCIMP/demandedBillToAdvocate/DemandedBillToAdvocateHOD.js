...
const DemandedBillToAdvocateHOD = () => {
  ...
  const handleNext = (data) => {
    ...
    console.log("finalBodyForAPi", finalBody, attachments, role);
  ...
  useEffect(() => {
    console.log("ABC", JSON.parse(localStorage.getItem("tableRowData")));
    ...
    console.log("id435345", tableData?.id);
...
export default DemandedBillToAdvocateHOD;
